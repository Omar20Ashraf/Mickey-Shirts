...
@section('content')
    ...
    <h3>Edit Shirt info</h3>

    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            {!! Form::model($product,['route' => ['shirts.update',$product->id], 'method' => 'PUT', 'files' => true]) !!}
            ...
            <div class="form-group">
                ...
                <img class="img-responsive" src="/storage/photos/shirts/{{$product->image}}"><br>
